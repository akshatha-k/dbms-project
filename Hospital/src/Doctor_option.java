...
String branch_id;
    /**
     * Creates new form Doctor_option
     */
    public Doctor_option() {
        initComponents();
    }
    public Doctor_option(String c_id,String b_id)
    {
        initComponents();
        cust_id=c_id;
        branch_id=b_id;
    ...
    private void view_hiredActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view_hiredActionPerformed
                this.setVisible(false);
                 new Blood_Bank(cust_id,branch_id).setVisible(true);    
    ...
    private void hireActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hireActionPerformed
       this.setVisible(false);
        Create_app ob2 = new Create_app(cust_id,branch_id);
        ob2.setVisible(true);
